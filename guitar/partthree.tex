...
will use to play the scale's notes. This scale is referred to as a \q{movable
...
Count up to the fifth fret of your guitar. On most guitars, the fifth fret will
...
saying goes, \q{it's not called an F-chord for nothing!}
...
Remember to keep the up and down strumming motion in your picking hand constant
- even when you're not actually strumming the chord. Try saying out loud \term{down,
down up, up down up} (or \term{1, 2 and, and 4 and}) as you're playing the pattern.
...
\nameref{sec:song6} - performed by The Animals
...
\nameref{sec:song7} - performed by Pearl Jam
...
\nameref{sec:song8} - performed by The Counting Crows
...
\nameref{sec:song9} - performed by Don McLean
